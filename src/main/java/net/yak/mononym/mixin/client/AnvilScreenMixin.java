...
public abstract class AnvilScreenMixin {
    ...
    @WrapOperation(method = "setup", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/gui/screen/ingame/AnvilScreen;addDrawableChild(Lnet/minecraft/client/gui/Element;)Lnet/minecraft/client/gui/Element;"))
    ...
    @WrapOperation(method = "drawForeground", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/gui/screen/ingame/ForgingScreen;drawForeground(Lnet/minecraft/client/gui/DrawContext;II)V"))
    private void mononym$removeAnvilText(AnvilScreen instance, DrawContext context, int x, int y, Operation<Void> original) {
    ...
    private void mononym$removeTextBackground(DrawContext instance, RenderPipeline pipeline, Identifier sprite, int x, int y, int width, int height, Operation<Void> original) {
        original.call(instance, pipeline, TEXT_FIELD_DISABLED_TEXTURE, x, y, width, height);
    }
